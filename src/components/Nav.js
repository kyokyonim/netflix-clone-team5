  ...
  return (
    <nav className="nav">
      ...
      <div className="nav__right">
        <Image src="/image/Search.png" alt="search" className="nav__icon" width={22} height={22} />
        ...
        {/* Profile dropdown */}
        <div className="nav__profileWrap" ref={wrapRef}>
          <button
            type="button"
          ...
          >
            ...
            <Image
              alt="arrow"
              src={isOpen ? "/image/ArrowUp.png" : "/image/ArrowDown.png"}
          ...
          {isOpen && (
            <div className="nav__dropdown">
              <a className="nav__dropdownItem" href="#">
                프로필 관리
              </a>
              <a className="nav__dropdownItem" href="#">
                계정
              ...
              <button
                type="button"
                className="nav__dropdownItem nav__dropdownBtn"
                onClick={() => {
                  setIsOpen(false);
                  alert("로그아웃(데모)");
                }}
